...
export default function FilterFrame({title, children, ...props}: FilterFrameProps){
    ...
    return (
        <Card className={`${wClassName} ${bgClassName} ${className} transition ease-in-out delay-150`}>
