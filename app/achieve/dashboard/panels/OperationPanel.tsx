import { OperationDataTreeViewTable } from "@/app/achieve/dashboard/tables/TreeViewTable";
import {
  getOperationData,
  getMonitoringGroupData,
...
export async function OperationPanel() {
  ...
  const treeList = tree.toList(assetsData).filter((item) => item.index !== -1);
