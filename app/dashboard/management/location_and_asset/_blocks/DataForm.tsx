...
// import { createNewData, updateData } from "../_actions/LocationDataAction";
...
//   const colorVariant = getLocationColor(assetData.type);
...
//               <DashboardLabelChip
//                 title={getLocationEntityUIConfig(assetData.type).label}
//                 color={getLocationEntityUIConfig(assetData.type).color}
//               />
//               <FormControl>
//                 <Input
//                   className={cn(
...
//                   )}
//                   title={`${getLocationEntityUIConfig(assetData.type).label}`}
//                   placeholder={`輸入 ${getLocationEntityUIConfig(assetData.type).label} 名稱`}
//                   {...field}
//                 />
//               </FormControl>
//               <FormMessage />
