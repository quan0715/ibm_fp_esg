...
export function AuthCard({ children, title, description }: AuthCardProps) {
  return (
    <Card className="animate-fadeIn transition-all w-screen h-screen md:w-[540px] md:h-auto bg-background/80 shadow-2xl p-8 backdrop-blur-xl rounded-xl flex flex-col justify-center align-middle">
